            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right"><a href="{{route('brand.add')}}"><i class="fas fa-plus"></i>
                                Add</a></div>
                    </div>
                </div>
                <!-- /.card-header -->
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('brand.edit',$user->id)}}" class="pl-3 pr-3"><i
