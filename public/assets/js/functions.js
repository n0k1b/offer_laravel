...
!(function (e) {
    ...
    (SEMICOLON.initialize = {
        ...
        execPlugin: function (e, i, n) {
            ...
            n
                ?
                (i.trigger && !scwEvents[i.trigger] && (l.trigger(i.trigger), (scwEvents[i.trigger] = !0)), i.execfn && SEMICOLON.initialize.execFunc(i.execfn, window, e), i.class && o.addClass(i.class)) :
                (i.trigger && !scwEvents[i.trigger] ?
                    ...
                    i.execfn &&
                    (i.trigger && !s ?
                        l.on(i.trigger, function () {
                            SEMICOLON.initialize.execFunc(i.execfn, window, e);
                        }) :
                        SEMICOLON.initialize.execFunc(i.execfn, window, e)),
                    i.class && o.addClass(i.class));
        },
    ...
    (SEMICOLON.header = {
        ...
        initialize: function () {
            u.length > 0 && (e(".header-wrap-clone").length < 1 && u.after('<div class="header-wrap-clone"></div>'), (y = e(".header-wrap-clone"))),
                $.length > 0 && ($.find("#page-menu-wrap").after('<div class="page-menu-wrap-clone"></div>'), (q = e(".page-menu-wrap-clone"))),
        ...
        menufunctions: function () {
            ...
            o.hasClass("device-xl") || o.hasClass("device-lg") ?
                ...
                o.hasClass("overlay-menu") && b.hasClass("on-click") && (o.hasClass("device-xl") || o.hasClass("device-lg")) ?
                ...
                (o.hasClass("side-header") && b.hasClass("on-click")) || o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs") ?
                (i.removeClass("icon-rotate-90"),
                    ...
                    (i = i.add(t.filter('[href^="#"]'))).off("click").on("click", function (i) {
                        ...
                        n.parents(".sub-menu").siblings().find(".sub-menu-trigger").removeClass("icon-rotate-90"),
                            n.parents(".sub-menu").siblings().find(a).filter(":not(:animated)").stop(!0, !0).slideUp(r),
                            n.parent(l).children(s).filter(":not(:animated)").stop(!0, !0).slideToggle(r);
                ...
                (o.hasClass("overlay-menu") || o.hasClass("side-header")) && (o.hasClass("device-xl") || o.hasClass("device-lg")) ?
                (b.find(a).stop(!0, !0).slideUp(r),
                    e(l).hover(
                        function (i) {
                ...
                t.off("click").on("click", function (i) {
                    let n = e(this);
                    n.parents(".sub-menu").siblings().find(a).removeClass("d-block"),
                        n.parent(l).children(s).toggleClass("d-block"),
                        n.parent(l).siblings().removeClass("current"),
                        n.parent(l).toggleClass("current"),
                        i.preventDefault();
                }),
                (e(".top-links").hasClass("on-click") || o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) &&
                ...
                .on("click", function () {
                    return (
                        (o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) &&
                        (b.find(".mobile-primary-menu").length > 0 ?
                            (e(".primary-menu:not(.mobile-menu-off-canvas) .mobile-primary-menu").stop(!0, !0).slideToggle(r), e(".primary-menu.mobile-menu-off-canvas .mobile-primary-menu").toggleClass("d-block")) :
                            (e(".primary-menu:not(.mobile-menu-off-canvas) .menu-container").stop(!0, !0).slideToggle(r), e(".primary-menu.mobile-menu-off-canvas .menu-container").toggleClass("d-block"))),
        ...
        fullWidthMenu: function () {
            ...
            if (
                (d.find(".container-fullwidth").length > 0 && e(".mega-menu:not(.mega-menu-full):not(.mega-menu-small) .mega-menu-content").css({
                        width: i
                    }),
        ...
        stickyMenu: function (e) {
            ...
            (i > e ?
                ...
                (d.filter(":not(.no-sticky)").addClass("sticky-header"),
                    ...
                    (i - e > Number(I) ?
                        (d.addClass("sticky-header-shrink"), C && (x.find("img").css({
                            height: Number(f)
                        }), SEMICOLON.header.menuItemsSpacing(O))) :
                        (d.removeClass("sticky-header-shrink"), C && (x.find("img").css({
                            height: Number(g)
                        }), SEMICOLON.header.menuItemsSpacing(h))))) :
                (SEMICOLON.header.removeStickyness(), C && (x.find("img").css({
                    height: Number(g)
                }), SEMICOLON.header.menuItemsSpacing(h)))),
        ...
        menuItemsSpacing: function (e) {
            ...
            o.hasClass("side-header") ||
                ...
                (b.hasClass("menu-spacing-margin") ?
                    "" == e ?
                    i.css({
                        "margin-top": "",
                        "margin-bottom": ""
        ...
        logo: function () {
            ...
            (!d.hasClass("dark") && !o.hasClass("dark")) || u.hasClass("not-dark") ?
                (z && e.attr("src") != z && e.attr("src", z), R && i.attr("src") != R && i.attr("src", R)) :
                (T && e.attr("src") != T && e.attr("src", T), F && i.attr("src") != F && i.attr("src", F)),
                d.hasClass("sticky-header") && (_ && e.attr("src") != _ && e.attr("src", _), A && i.attr("src") != A && i.attr("src", A)),
                (o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) && (H && e.attr("src") != H && e.attr("src", H), D && i.attr("src") != D && i.attr("src", D));
        },
        stickyMenuClass: function () {
            ...
            if (i > 0) {
                ...
                for (n = 0; n < i; n++)
                    "not-dark" == e[n] ?
                    (d.removeClass("dark"), u.filter(":not(.not-dark)").addClass("not-dark")) :
                    "dark" == e[n] ?
                    (u.removeClass("not-dark force-not-dark"), d.hasClass(e[n]) || d.addClass(e[n])) :
            ...
            e("#top-search-trigger")
                ...
                .on("click", function (e) {
                    clearTimeout(n),
                        ...
                        (o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) &&
                        (b.filter(":not(.mobile-menu-off-canvas)").find(".menu-container").slideUp(200), b.filter(".mobile-menu-off-canvas").find(".menu-container").toggleClass("d-block", !1)),
        ...
        miscFunctions: function () {
            ...
            e(document).on("click", function (t) {
                e(t.target).closest(".top-search-form").length ||
                    ...
                    b.hasClass("mobile-menu-off-canvas") &&
                    (e(t.target).closest(".primary-menu.mobile-menu-off-canvas .menu-container").length ||
                        (b.filter(".mobile-menu-off-canvas").find(".menu-container").toggleClass("d-block", !1), o.toggleClass("primary-menu-open", !1))),
        ...
        sliderParallax: function () {
            ...
            (!o.hasClass("device-xl") && !o.hasClass("device-lg")) || SEMICOLON.isMobile.any() ?
                (Q.find(".slider-inner").length > 0 ?
                    ...
                    Q.addClass("slider-parallax-visible").removeClass("slider-parallax-invisible")) :
                (a + n + 50 > s ?
                    (Q.addClass("slider-parallax-visible").removeClass("slider-parallax-invisible"),
                        s > n ?
                        Q.find(".slider-inner").length > 0 ?
                        ...
                        (SEMICOLON.slider.sliderParallaxSet(0, 0, ie), SEMICOLON.slider.sliderParallaxSet(0, 0, ee)) :
                        (SEMICOLON.slider.sliderParallaxSet(0, 0, Z), SEMICOLON.slider.sliderParallaxSet(0, 0, ee))) :
                    Q.addClass("slider-parallax-invisible").removeClass("slider-parallax-visible"),
        ...
        extras: function () {
            let i = setInterval(function () {
                "pluginBootstrapReady" in scwEvents &&
                    (e().tooltip ? e('[data-bs-toggle="tooltip"]').tooltip({
                            container: "body"
                        }) : console.log("extras: Bootstrap Tooltip not defined."),
                        e().popover ? e('[data-bs-toggle="popover"]').popover({
                            container: "body"
        ...
        windowscroll: function () {
            ...
            $.length > 0 &&
                (q.css({
                    ...
                    setTimeout(function () {
                        d.length > 0 && !d.hasClass("no-sticky") && (o.hasClass("device-xl") || o.hasClass("device-lg") || "true" == p) ?
